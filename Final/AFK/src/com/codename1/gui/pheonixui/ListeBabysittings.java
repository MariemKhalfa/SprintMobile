 ...
 * @author Mariem
 */
public class ListeBabysittings  extends BaseForm {
Form f;
    public ListeBabysittings() {
    ...
    public ListeBabysittings(com.codename1.ui.util.Resources resourceObjectInstance) {
       // initGuiBuilderComponents(resourceObjectInstance);
        
        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label("Mes babysittings", "Title")
                       // new Label("19", "Babysitting")
                )
        );
        
        installSidemenu(resourceObjectInstance);
        
        getToolbar().addCommandToRightBar("", resourceObjectInstance.getImage("mbab.png"), e -> {});
        ...
        fab.addActionListener(e -> {
            ...
            int t = ListeBabysittings.this.getTintColor();
            ListeBabysittings.this.setTintColor(0);
            popup.showPopupDialog(new Rectangle(ListeBabysittings.this.getWidth() - 10, ListeBabysittings.this.getHeight() - 10, 10, 10));
            ListeBabysittings.this.setTintColor(t);
