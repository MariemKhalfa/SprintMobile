...
public class ServiceActivite {
    ...
    public void addActivite(Activite e) {
        ...
        con.setPost(true);
        con.setUrl("http://localhost/GitHub/Mobilefinal/API2/web/app_dev.php/activite/ajout?type=" + e.getType() + "&sdate=" + toDate(e.getDate().toString()) + "&ageMin=" + e.getAge_min() + "&heure=" + e.getHeure()
    ...
    public ArrayList<Activite> listActivite() {
        ...
        con.setHttpMethod("GET");
        con.setPost(true);
        con.setUrl("http://localhost/GitHub/Mobilefinal/API2/web/app_dev.php/activite/list");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                //listTasks = getListTask(new String(con.getResponseData()));
    ...
    public ArrayList<Activite> searchActivite(String key) {
        ...
        con.setHttpMethod("GET");
        con.setPost(true);
        con.setUrl("http://localhost/GitHub/Mobilefinal/API2/web/app_dev.php/activite/search/" + key);
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                //listTasks = getListTask(new String(con.getResponseData()));
